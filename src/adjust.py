...
class Adjust:
    ...
    def setup_windows(self):
        ...
        # 创建装甲板参数滑动条
        cv2.createTrackbar("arm_max", "params", self.armor_params["armor_area_max"], 850000, lambda new_armor_area_max: self.armor_area_max("armor_area_max", new_armor_area_max))  # 创建装甲板面积最大滑动条
